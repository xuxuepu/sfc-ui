<template>
  <div class="sfc-range" :class="{ 'sfc-range--disabled': disabled }">
    <slot name="start"></slot>
    <div class="sfc-range-content" ref="content">
      <div class="sfc-range-runway" :style="{ 'border-top-width': barHeight + 'px' }"></div>
      <div class="sfc-range-progress" :style="{ width: progress + '%', height: barHeight + 'px' }"></div>
      <div class="sfc-range-thumb" ref="thumb" :style="{ left: progress + '%' }"></div>
    </div>
    <slot name="end"></slot>
  </div>
</template>
