<template>
  <sfc-popup v-model="visible" position="bottom" class="sfc-datetime">
    <sfc-picker
      :slots="dateSlots"
      @change="onChange"
      :visible-item-count="7"
      class="sfc-datetime-picker"
      ref="picker"
      show-toolbar>
      <span class="sfc-datetime-action sfc-datetime-cancel" @click="visible = false">{{ cancelText }}</span>
      <span class="sfc-datetime-action sfc-datetime-confirm" @click="confirm">{{ confirmText }}</span>
    </sfc-picker>
  </sfc-popup>
</template>
...
<script type="text/babel">
  import picker from 'sfc-ui/packages/picker/index.js';
  import popup from 'sfc-ui/packages/popup/index.js';
  if (process.env.NODE_ENV === 'component') {
    require('sfc-ui/packages/picker/style.css');
    require('sfc-ui/packages/popup/style.css');
  }
