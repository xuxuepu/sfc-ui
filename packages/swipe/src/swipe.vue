...
<template>
  <div class="sfc-swipe">
    <div class="sfc-swipe-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="sfc-swipe-indicators" v-show="showIndicators">
      <div class="sfc-swipe-indicator"
...
<script>
  ...
  import { addClass, removeClass } from 'sfc-ui/src/utils/dom';
