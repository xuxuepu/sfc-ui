<template>
  <div
    ...
    @mouseleave="endDrag"
    @touchend="endDrag"
    class="sfc-tab-container">
    <div
      ref="wrap"
      class="sfc-tab-container-wrap">
      <slot></slot>
    </div>
  </div>
</template>
...
<script>
import { once } from 'sfc-ui/src/utils/dom';
 ...
 *
 * @example
 * <sfc-tab-container v-model="selected">
 *   <sfc-tab-container-item id="1"> 内容A </sfc-tab-container-item>
 *   <sfc-tab-container-item id="2"> 内容B </sfc-tab-container-item>
 *   <sfc-tab-container-item id="3"> 内容C </sfc-tab-container-item>
 * </sfc-tab-container>
 */
export default {
  name: 'sfc-tab-container',
