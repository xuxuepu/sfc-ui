<template>
  <div class="page-msgbox">
    ...
    <div class="page-msgbox-wrapper">
      <sfc-button @click.native="openAlert" size="large">打开 alert 提示框</sfc-button>
      <sfc-button @click.native="openConfirm" size="large">打开 confirm 提示框</sfc-button>
      <sfc-button @click.native="openPrompt" size="large">打开 prompt 提示框</sfc-button>
    </div>
  </div>
</template>
