<template>
  <div class="page-picker">
    ...
    <div class="page-picker-wrapper">
      <sfc-picker :slots="yearSlot" @change="onYearChange" :visible-item-count="3"></sfc-picker>
    </div>
    <p class="page-picker-desc">出生年份: {{ year }}</p>

    <div class="page-picker-wrapper">
      <sfc-picker :slots="dateSlots" @change="onDateChange" :visible-item-count="3"></sfc-picker>
    </div>
    <p class="page-picker-desc">在校时间: {{ dateStart }} 至 {{ dateEnd }}</p>

    <div class="page-picker-wrapper">
      <sfc-picker :slots="addressSlots" @change="onAddressChange" :visible-item-count="5"></sfc-picker>
    </div>
